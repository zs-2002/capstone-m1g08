...
class SupervisorInterface:
    def __init__(self):
        ...
        video_frame.grid(row=0, column=0, columnspan=2, pady=10)
        self.video_label = tk.Label(video_frame, text="VIDEO", font=("Arial", 14), fg="white", bg="black", width=50, height=20)
