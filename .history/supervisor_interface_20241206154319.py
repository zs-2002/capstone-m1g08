...
class SupervisorInterface:
    def __init__(self):
        ...
        # Bind selection event to debug the selection
        self.current_process_dropdown.bind("<<ComboboxSelected>>", self.on_process_selected)
    ...
    def on_process_selected(self, event):
        ...
        print("Process selected:", selected_process)  # Debugging line

    def start_operator_interface(self):
        selected_process = self.current_process_var.get().strip()  # Get and trim the value
        print("Selected process in start_operator_interface:", selected_process)  # Debugging line
        ...
        print("Valid dropdown values:", valid_processes)  # Debugging line
