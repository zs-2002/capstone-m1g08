...
class SupervisorInterface:
    ...
    def save_steps(self):
        ...
        processes = list(df['process'].unique())  # Ensure unique and valid process names
    ...
    def start_operator_interface(self):
        ...
        if selected_process not in self.current_process_dropdown['values']:
...
# Placeholder for OperatorInterface class (should be implemented or imported)
def OperatorInterface(selected_process):
    print(f"Operator Interface launched for process: {selected_process}")
